...
#
html_theme_options = {
    "repository_url": "https://github.com/courses/courses",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'courses'),
                os.path.join(root_path, 'courses/migrations')])
